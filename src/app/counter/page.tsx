...
import {addDays, addYears, differenceInDays, isPast, isToday} from "date-fns";
            ...
            <div className="main_inner">
                <div className="counter_main">
                    <div className="counter_section">
                        {/*생일*/}
                        <div className={"counter_card " + (isToday(birthDay) ? "active" : "")}>
                        ...
                        {/*방송 1주년*/}
                        <div className={"counter_card " + (isToday(broadcastDay) ? "active" : "")}>
                        ...
                        {/*방송 200일*/}
                        <div className={"counter_card " + (isToday(firstDay) ? "active" : "")}>
                    ...
                    <div className="counter_section">
                        {/*방송 300일*/}
                        <div className={"counter_card " + (isToday(secondDay) ? "active" : "")}>
                        ...
                        {/*방송 400일*/}
                        <div className={"counter_card " + (isToday(thirdDay) ? "active" : "")}>
                        ...
                        {/*방송 500일*/}
                        <div className={"counter_card " + (isToday(fourthDay) ? "active" : "")}>
                    ...
                    {dDayStatus ? <Crossfire autorun={{ speed: 3 }} /> : null}
                    {dDayStatus ? <Fireworks autorun={{ speed: 1 }} /> : null}
                    {dDayStatus ? <Pride autorun={{ speed: 2 }} /> : null}
                </div>
            </div>
        </div>
    );
